...
type Config struct {
	...
	SkatteverketJWTConfig gojwt.Config
}
...
func New(config Config) (*Client, error) {
	...
	c.skatteverketJWT = gojwt.New(config.SkatteverketJWTConfig)
...
func (c *Client) newRequest(ctx context.Context, method, path string, body interface{}) (*http.Request, error) {
	...
	req.Header.Set("Authorization", fmt.Sprintf("Bearer: %s", c.skatteverketJWT.JWT.RAW))
	req.Header.Set("skv_client_correlation_id", uuid.NewString())
	return req, nil
}
